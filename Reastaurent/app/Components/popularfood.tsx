    ...
    return (
        ...
        <section className="bg-[#f8f3eb] py-16">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <p className="text-1xl font-serif text-center mb-12">
                    We collect the best quality of ingredients From market. With the best <br />execution we provide our guest fresh & very Delicious Food.
                </p>
                <br />
                <br />
                <br />
            ...
            "
                ...
                <div className="flex justify-center mt-8">
                    <button className="bg-[#b68a3a] text-white  py-1 px-4 rounded-sm  sm:text-lg md:text-xl transition transform hover:scale-105 hover:shadow-lg">
                        See All
                    </button>
                </div>
